...
//  TFile *inf = new TFile("../ToMerge20140408/SigmaBs.root");//default
//  TFile *inf = new TFile("../ToMerge20140409/SigmaBs.root");//poisson sig
//  TFile *inf = new TFile("../ToMerge20140416/SigmaBs.root");//update
//  TFile *inf = new TFile("../ToMerge20140426/SigmaBs.root");//
//  TFile *inf = new TFile("../ToMerge20140426_2/SigmaBs.root");//update
  TFile *inf = new TFile("../ToMerge20140428/SigmaBs.root");//update
...
//	true_y = new TH1D("true_y","yields",20,150,500);                                   
  ...
  if(bin==0)  leg->AddEntry(toys,Form("pt 10~60, true#: %.2f", true_y->GetMean()),"");
  leg->Draw();
...
//      pull->Fill((yield-36.5093)/yield_err);
